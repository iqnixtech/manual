...
Первым делом необходимо перейти на официальный сайт электронного журнала «ЦОП: Журнал» по ссылке https://elj.mokit.online (Рис.1.1)
...
После введённых данных система попросит сменить пароль на более удобный для пользователя (Рис.1.2).
 
![Тут текст](https://ie.wampi.ru/2022/09/18/image_2022-09-15_22-18-16.png)
 Рисунок 1.2 - «Сброс пароля»
...
![Тут текст](https://im.wampi.ru/2022/09/18/Group-148.png)
 Рисунок 2.1 - «Расписание»

#### 3 Электронный журнал

При переходе в раздел Электронный журнал (Рис.3.1), необходимо выбрать группу (Рис.3.2) и пару (Рис.3.3), нажав на кнопку Открыть у Вас отобразится журнал со студентами, оценками и датами (Рис.3.4).

![Тут текст](https://ie.wampi.ru/2022/09/18/Group-149.png) 
Рисунок 3.1 - «Электронный журнал»  
...
<html> 
 ...
 <body> 
  <p> 
   <img src="https://ic.wampi.ru/2022/09/24/Group-183-1.png" alt= "Картинка 1" width="375" height="220" > 
...
![Тут текст](https://ic.wampi.ru/2022/09/18/Group-141.png)
 Рисунок 3.4 - «Страница электронного журнала»


4 КТП Календарно-тематический план

Документ, обеспечивающий методически правильное планирование учебных занятий, располагается внизу страницы с электронным журналом (Рис.4.1). Его необходимо загрузить нажав на кнопку Добавить (Рис.4.2).
...
![Тут текст](https://im.wampi.ru/2022/09/18/image-14-1.png)
 ...
 Рисунок 4.2 -««Кнопка Добавить»

Чтобы создать новую запись в КТП Вам необходимо добавить дату, на которую будет назначено задание, в разделе «Дата создания», далее назначить тему занятий в строке «Тема занятия», в разделе «Домашнее задание» Вы можете написать дз в текстовом формате, материалы в других форматах можно добавить, нажав кнопку «Материалы» (Рис.4.3).
 
 ![Тут текст](https://ic.wampi.ru/2022/09/23/Group-181.png)
 Рисунок 4.3 - «Новая запись в КТП»


5 Страница «Помощь»

В разделе «Помощь» вы можете найти интересующий Вас вопрос или же задать свой личный. Для того что бы задать свой вопрос, необходимо нажать на иконку «Заявка на помощь» (Рис.5.1).  
 
 ![Тут текст](https://ic.wampi.ru/2022/09/18/Group-137.png)
 Рисунок 5.1 - «Заявка на помощь»
...
Стоит обратить внимание, что электронную почту не нужно указывать. Ответ придёт в соответствии с почтой, которая привязана к вашему аккаунту (Рис.5.2).

![Тут текст](https://ie.wampi.ru/2022/09/18/Group-157.png)
 Рисунок 5.2 - «Заявка на помощь»
...
<p><span style="color:#7350f2">2 Первый вход в систему</span></p>
...
<p><span style="color:#7350f2">3 Страница «Электронный журнал»</span></p>
...
<p><span style="color:#7350f2">4 Страница «Календарно-тематический план»</span></p>
...
<p><span style="color:#7350f2">5 Страница «Расписание»</span></p>
...
<p><span style="color:#7350f2">6 Страница «Помощь»</span></p>
